...
Array.prototype.slice.call(arguments)))},m:function(){return{then:function(a,c,b){if("function"!==typeof a)throw Error("handler MUST be a function");f.push(a);"function"===typeof c&&k.push(c);"function"===typeof b&&e.push(b)},catch:function(a){if("function"!==typeof a)throw Error("handler MUST be a function");e.push(a)},Ka:function(a){if("function"!==typeof a)throw Error("handler MUST be a function");c.push(a)}}}()}}b.defer=d;b.all=function(d){function m(a,z){c--;k[a]=z;c||e.resolve(k)}function f(){e.reject.apply(e,
Array.prototype.slice.call(arguments))}var k,e,c;if(!d||"object"!==typeof d)throw Error("promises MUST be an object or an Array");Array.isArray(d)?k=[]:k={};e=b.defer();c=Object.keys(k).length;Object.keys(d).forEach(function(a){d.then(m.bind(null,a),void 0,f)});return e.m};return b}();d.Fb=function(){function b(b,f){var k,e=d.Ua.defer();e.then(b);k=g.length;g[k]=e;m[k]=e.m;setTimeout(function(){g.splice(k,1);m.splice(k,1);e.resolve()},f);return e.m}var m=[],g=[];b.cancel=function(b){b=m.indexOf(b);
return-1<b?(g[b].reject("cancelled"),!0):!1};return b}();return d}();return{P:function(d){var b;if(1===arguments.length)return k[d]||null;if(k[d])throw Error("module named "+d+" already exists!");b={ha:{}};b.V=t.bind(null,b.ha);k[d]=b},Ja:f,extend:p,ha:function(){var d=k.dataConductor;return d?d.ha:{}}}}();x.P("dataConductor",[]);(function(t){t.V("jsdcObjectStorageService",function(){return function(){function p(b){return d[b]||null}function f(b){var m=p(b);delete d[b];return m||null}function k(b){if(!b||
...
k.next;return k?k.data:null};this.count=function(){return r};this.all=function(){for(var d=[],b=f;b;)d.push(b.data),b=b.next;return d}}}])})(x.P("dataConductor"));(function(t){t.V("jsdcIndexedPageCache",["jsdcEventEmitter","jsdcIndexedCollection",function(p,f){function k(){function g(a,b,d,e,g){q=(q+1)%(Number.fa||Number.MAX_VALUE);a={index:a,w:b,N:d,F:e,data:g,Na:null,G:q};c.items.add(a);return a}function t(a,b){function d(c){k(c.length,function(b){k(a,p.bind(null,c[b]*a))})}function f(c){m(c.length,
...
a,n.b("retryCountChanged",a,c));else throw Error("retryCount MUST be number greater than or equal to 0");};this.state=function(){return{j:n.j(),filter:n.filter(),A:n.A(),O:n.O(),u:n.u(),I:n.I(),L:n.L(),M:n.M(),H:n.H()}};this.ca=function(a){if(!a||"object"!==typeof a)throw Error("supplied state MUST be an object");a.hasOwnProperty("adapter")&&n.sa(a.j);a.hasOwnProperty("filter")&&n.ka(a.filter);a.hasOwnProperty("existingMode")&&n.va(a.A);a.hasOwnProperty("executionMode")&&n.Qa(a.O);a.hasOwnProperty("parallel")&&
...
g)).Ka(b);c.a.ga().then(d).catch(q.reject);p.exec=q.m;return p}var e=this,c={index:null,oa:!1,Kb:b.qb,ra:b.mb,Y:b.Ab,X:b.tb,J:b.ab,a:new d,count:0};k.call(this);this.Ya=m;this.aa=b.aa;this.Z=b.Z;this.da=b.da;this.ba=b.ba;this.$=b.$;this.R=b.R;this.ea=b.ea;c.a.f().Sa(function(a,c){function b(a){return isNaN(a)?null:a}var d,f,g,k,m=e.index();d=a.pa(m);f=a.La(m);for(c--;c;)g=b(d[d.length-1]),k=b(f[0]),null!==g&&null!==k?(g=Math.abs(g-m),k=Math.abs(k-m),g>k?f.shift():d.pop()):null!==g?d.pop():f.shift(),
...
p;this.za=function(a){function b(a,d){a=Math.abs(a.index-c.index);d=Math.abs(d.index-c.index);return a===d?0:a>d?1:-1}var d=c.a.f(),e;a!==p()&&(d.za(a),d.D()===d.R.clear||0===d.count()?c.index=null:null===d.info(c.index)&&(e=d.U().sort(b),c.index=e[0]),c.count=d.count());return a};this.state=function(){var a;a=c.a.f().state();a=t.extend(a,c.a.state());a.ra=a.s;delete a.s;return a=t.extend(a,{index:e.index(),Y:e.Y(),X:e.X(),J:e.J(),filter:e.filter()})};this.ca=function(a){if(!a||"object"!==typeof a)throw Error("supplied state MUST be an object");
c.a.f().ca(a);c.a.ca(a);c.oa=!0;a.hasOwnProperty("filter")&&e.ka(a.filter);a.hasOwnProperty("index")&&e.wb(a.index);a.hasOwnProperty("maxPages")&&e.xb(a.ra);a.hasOwnProperty("padLow")&&e.zb(a.Y);a.hasOwnProperty("padHigh")&&e.yb(a.X);c.oa=!1;a.hasOwnProperty("countMode")&&e.vb(a.J);a=q();return a=a.exec};this.D=c.a.f().D;this.Ba=c.a.f().Ba;this.B=c.a.f().B;this.wa=c.a.f().wa;this.ra=c.a.f().s;this.xb=c.a.f().Ra;this.S=c.a.S;this.u=c.a.u;this.Aa=c.a.Aa;this.I=c.a.I;this.ua=c.a.ua;this.T=c.a.T;this.ta=
...
break;case m.fixed:case m.na:a.resolve(c.count);break;default:throw Error('Unrecognised count mode "'+e.J()+'"');}return a.m}}var m=b.Ya={ob:"none",j:"adapter",fixed:"fixed",na:"detect"};b.ab=m.j;b.Ab=0;b.tb=0;b.qb=1;b.mb=Number.fa||Number.MAX_VALUE;b.aa=d.aa;b.Z=d.Z;b.da=d.da;b.ea=d.ea;b.ba=p.ba;b.$=p.$;b.R=p.R;return b}])})(x,x.P("dataConductor"));modules.Gb=x.ha()})(module);
