...
(function object_storage_service(app) {
    ...
    app.factory('admObjectStorageService', objectStorageServiceFactory);
...
(function adapter_service(app) {
    ...
    app.factory('admAdapterService', ['admObjectStorageService', adapterServiceFactory]);
...
(function indexed_collection_service(app) {
    ...
    app.factory('admIndexedCollection', indexedCollectionFactory);
...
(function queue_service(app) {
    ...
    app.factory('admQueue', [queueFactory]);
...
(function indexed_page_cache_service(app) {
    ...
    //Register the factory.
    app.factory('admIndexedPageCache', ['admEventEmitter', 'admIndexedCollection', indexedPageCacheFactory]);
...
(function event_emitter_service(app) {
    ...
    //Register the factory
    app.factory('admEventEmitter', [eventEmitterFactory]);
...
(function loader_service(sys, app) {
    ...
    //Register the factory
    app.factory('admLoaderService', ['$timeout', '$q', 'admEventEmitter', 'admAdapterService', 'admQueue', 'admIndexedPageCache', loaderServiceFactory]);
...
(function indexed_pager_service(sys, app) {
    ...
    //Register the factory.
    app.factory('admIndexedPagerService', ['$q', 'admEventEmitter', 'admIndexedPageCache', 'admLoaderService', indexedPagerServiceFactory]);
    ...
    function indexedPagerServiceFactory($q, EventEmitter, IndexedPageCache, LoaderService) {
        ...
        */
        function IndexedPagerService() {
            ...
            this.info = internal.loader.info;
            this.count = getCount;
...
pmod = window.angular.module(PROJECT_MODULE);
    modules.exports = {
        admAdapterService: pmod.get('admAdapterService'),
        admEventEmitter: pmod.get('admEventEmitter'),
        admIndexedCollection: pmod.get('admIndexedCollection'),
        admIndexedPageCache: pmod.get('admIndexedPageCache'),
        admIndexedPagerService: pmod.get('admIndexedPagerService'),
        admLoaderService: pmod.get('admLoaderService'),
        admObjectStorageService: pmod.get('admObjectStorageService'),
        admQueue: pmod.get('admQueue')
    };
}(module));