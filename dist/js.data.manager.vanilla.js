(function (exports) {
    'use strict';
    var window = {};window.angular = (function () {
    'use strict';
    ...
    return {
        ...
        equals: equals,
        extend: extend,
        /** Returns the registered factories (so they can, for example, be added to an object for commonjs) */
        factories: function () {
            var mod = modules[PROJECT_MODULE];
            if (mod) {
                return mod.factories;
            } else {
                return { };
            }
        }
    ...
    */
    function module(name) {
        ...
        if (arguments.length === 1) {
            ...
            mod = { };
            mod.factories = { };
            mod.factory = factory.bind(null, mod.factories);
            modules[name] = mod;
        }
    }
