...
throw Error("not implemented");}function p(d){function b(b){var e=m(d[b]);m(g[b])&&e?p(d[b],g[b]):d[b]=g[b]}function m(b){var d=typeof b;return!b||"function"!==d&&"object"!==d?null:d}var g,e;return 2>arguments.length?d:m(d)?(g=arguments[1],m(g)&&(e=Object.keys(g),e.forEach(b)),e=Array.prototype.slice.call(arguments,2),e.unshift(d),p.apply({},e)):d}function e(d,b){var m,g,k,r,q;if(d===b)return!0;if(d&&b&&"function"!==typeof d&&"function"!==typeof b&&(m=Object.keys(d),g=Object.keys(b),m.length===g.length)){m.sort();
g.sort();for(q=0;q<m.length;q++){if(m[q]!==g[q])return!1;k=d[m[q]];r=b[g[q]];k=e(k,r);if(!k)return!1}return!0}return!1}var k={},r=function(){var d={};d.Va=function(){function b(b){var e=d();return b(e.resolve,e.reject)}function d(){function b(c,w){w.apply(a,c)}var m=!1,e=[],k=[],f=[],c=[],a;return a={resolve:function(){m||(m=!0,e.forEach(b.bind(null,Array.prototype.slice.call(arguments))),c.forEach(b))},reject:function(){m||(m=!0,f.forEach(b.bind(null,Array.prototype.slice.call(arguments))),c.forEach(b))},
qb:function(){k.forEach(b.bind(null,Array.prototype.slice.call(arguments)))},l:function(){return{then:function(a,c,b){if("function"!==typeof a)throw Error("handler MUST be a function");e.push(a);"function"===typeof c&&k.push(c);"function"===typeof b&&f.push(b)},catch:function(a){if("function"!==typeof a)throw Error("handler MUST be a function");f.push(a)},La:function(a){if("function"!==typeof a)throw Error("handler MUST be a function");c.push(a)}}}()}}b.defer=d;b.all=function(d){function m(a,z){c--;
k[a]=z;c||f.resolve(k)}function e(){f.reject.apply(f,Array.prototype.slice.call(arguments))}var k,f,c;if(!d||"object"!==typeof d)throw Error("promises MUST be an object or an Array");Array.isArray(d)?k=[]:k={};f=b.defer();c=Object.keys(k).length;Object.keys(d).forEach(function(a){d.then(m.bind(null,a),void 0,e)});return f.l};return b}();d.Fb=function(){function b(b,e){var k,f=d.Va.defer();f.then(b);k=g.length;g[k]=f;m[k]=f.l;setTimeout(function(){g.splice(k,1);m.splice(k,1);f.resolve()},e);return f.l}
var m=[],g=[];b.cancel=function(b){b=m.indexOf(b);return-1<b?(g[b].reject("cancelled"),!0):!1};return b}();return d}();return{R:function(d){var b;if(1===arguments.length)return k[d]||null;if(k[d])throw Error("module named "+d+" already exists!");b={ha:{}};b.V=t.bind(null,b.ha);k[d]=b},Ka:e,extend:p,ha:function(){var d=k.dataConductor;return d?d.ha:{}}}}();x.R("dataConductor",[]);(function(t){t.V("jsdcObjectStorageService",function(){return function(){function p(b){return d[b]||null}function e(b){var m=
...
k.next;return k?k.data:null};this.count=function(){return r};this.all=function(){for(var d=[],b=e;b;)d.push(b.data),b=b.next;return d}}}])})(x.R("dataConductor"));(function(t){t.V("jsdcIndexedPageCache",["jsdcEventEmitter","jsdcIndexedCollection",function(p,e){function k(){function g(a,b,d,f,g){q=(q+1)%(Number.ca||Number.MAX_VALUE);a={index:a,w:b,O:d,G:f,data:g,Oa:null,H:q};c.items.add(a);return a}function t(a,b){function d(c){k(c.length,function(b){k(a,p.bind(null,c[b]*a))})}function e(c){m(c.length,
...
c.sort(b);c.length>d;)c[0].cancel(),c.shift()}function x(a){return a.index}function F(){}var n=this,h={H:0,s:null,I:null,filter:null,f:new m,v:new b,qa:0,g:{},i:{},B:g.ib,P:g.hb,u:g.Ga,J:g.ca,M:g.Xa,N:g.Ya,A:g.ab,T:g.Fa,L:g.kb,W:g.lb};r.call(this);this.aa=v;this.Z=q;this.f=function(){return h.f};this.s=function(){return h.s};this.I=function(){return h.I};this.sa=function(a){var c,b;if("string"===typeof a){if(c=d.global.find(a),!c)throw Error('adapter named "'+a+'" not found!');}else if("object"===
...
this.Da=function(a){var c;if(0<=a)c=h.M,a!==c&&(h.M=a,n.b("retryCountChanged",a,c));else throw Error("retryCount MUST be number greater than or equal to 0");};this.state=function(){return{s:n.s(),filter:n.filter(),B:n.B(),P:n.P(),u:n.u(),J:n.J(),M:n.M(),N:n.N(),A:n.A()}};this.da=function(a){if(!a||"object"!==typeof a)throw Error("supplied state MUST be an object");a.hasOwnProperty("adapter")&&n.sa(a.s);a.hasOwnProperty("filter")&&n.ka(a.filter);a.hasOwnProperty("existingMode")&&n.wa(a.B);a.hasOwnProperty("executionMode")&&
...
var p={},v=g.aa={replace:"replace",ia:"ignore",Ja:"drop"},q=g.Z={Na:"instant",Ia:"delayed"},f=g.ea={all:"all",ia:"ignore"},c=g.fa={error:"error",cancel:"cancel"};g.Ga=1;g.ca=!1;g.Ya=2E3;g.Xa=0;g.kb=Number.MAX_VALUE;g.Fa=Number.MAX_VALUE;g.ib=v.Ja;g.hb=q.Na;g.ab=f.all;g.lb=c.error;return g}])})(x,x.R("dataConductor"));(function(t,p){p.V("jsdcIndexedPagerService",["$q","jsdcEventEmitter","jsdcIndexedPageCache","jsdcLoaderService",function(e,k,p,d){function b(){function g(a,c,b){b=parseInt(b,10);isNaN(b)||
...
g)).La(b);c.a.ga().then(d).catch(q.reject);p.exec=q.l;return p}var f=this,c={index:null,oa:!1,Jb:b.rb,ra:b.nb,Y:b.Ab,X:b.ub,K:b.bb,a:new d,count:0};k.call(this);this.Za=m;this.aa=b.aa;this.Z=b.Z;this.ea=b.ea;this.ba=b.ba;this.$=b.$;this.S=b.S;this.fa=b.fa;c.a.f().Ta(function(a,c){function b(a){return isNaN(a)?null:a}var d,e,g,k,m=f.index();d=a.pa(m);e=a.Ma(m);for(c--;c;)g=b(d[d.length-1]),k=b(e[0]),null!==g&&null!==k?(g=Math.abs(g-m),k=Math.abs(k-m),g>k?e.shift():d.pop()):null!==g?d.pop():e.shift(),
...
p;this.Aa=function(a){function b(a,d){a=Math.abs(a.index-c.index);d=Math.abs(d.index-c.index);return a===d?0:a>d?1:-1}var d=c.a.f(),e;a!==p()&&(d.Aa(a),d.F()===d.S.clear||0===d.count()?c.index=null:null===d.info(c.index)&&(e=d.U().sort(b),c.index=e[0]),c.count=d.count());return a};this.state=function(){var a;a=c.a.f().state();a=t.extend(a,c.a.state());a.ra=a.o;delete a.o;return a=t.extend(a,{index:f.index(),Y:f.Y(),X:f.X(),K:f.K(),filter:f.filter()})};this.da=function(a){if(!a||"object"!==typeof a)throw Error("supplied state MUST be an object");
c.a.f().da(a);c.a.da(a);c.oa=!0;a.hasOwnProperty("filter")&&f.ka(a.filter);a.hasOwnProperty("index")&&f.wb(a.index);a.hasOwnProperty("maxPages")&&f.xb(a.ra);a.hasOwnProperty("padLow")&&f.zb(a.Y);a.hasOwnProperty("padHigh")&&f.yb(a.X);c.oa=!1;a.hasOwnProperty("countMode")&&f.vb(a.K);a=q();return a=a.exec};this.F=c.a.f().F;this.Ca=c.a.f().Ca;this.C=c.a.f().C;this.xa=c.a.f().xa;this.ra=c.a.f().o;this.xb=c.a.f().Sa;this.I=c.a.I;this.u=c.a.u;this.Ba=c.a.Ba;this.J=c.a.J;this.va=c.a.va;this.T=c.a.T;this.ua=
