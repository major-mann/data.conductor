...
c.sort(b);c.length>d;)c[0].cancel(),c.shift()}function x(a){return a.index}function F(){}var n=this,h={H:0,s:null,I:null,filter:null,f:new m,v:new b,qa:0,g:{},i:{},B:g.ib,P:g.hb,u:g.Ga,J:g.fa,M:g.Xa,N:g.Ya,A:g.ab,T:g.Fa,L:g.kb,W:g.lb};r.call(this);this.aa=v;this.Z=q;this.f=function(){return h.f};this.s=function(){return h.s};this.I=function(){return h.I};this.sa=function(a){var c,b;if("string"===typeof a){if(c=d.global.find(a),!c)throw Error('adapter named "'+a+'" not found!');}else if("object"===
